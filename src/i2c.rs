...
macro_rules! hal {
    ($i2c_type: ident, $apb_type: ident, $enr: ident, $rstr: ident, $i2cX: ident, $i2cXen: ident, $i2cXrst: ident) => {
...
hal!(I2C1, APB1R1, enr, rstr, i2c1, i2c1en, i2c1rst);
hal!(I2C2, APB1R1, enr, rstr, i2c2, i2c2en, i2c2rst);
hal!(I2C3, APB1R1, enr, rstr, i2c3, i2c3en, i2c3rst);
...
#[cfg(any(feature = "stm32l4x1", feature = "stm32l4x2", feature = "stm32l4x6"))]
hal!(I2C4, APB1R2, enr, rstr, i2c4, i2c4en, i2c4rst);
